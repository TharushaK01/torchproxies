...
//       section: "Residential Proxies",
//       countries: [
//         { name: "United States", ips: "4,429,824 IPs", code: "us", href: "/united-states/residential/" },
//         { name: "Germany", ips: "4,429,824 IPs", code: "de", href: "/germany/residential/" },
//         { name: "United Kingdom", ips: "4,429,824 IPs", code: "gb", href: "/united-kingdom/residential/" },
//         { name: "Australia", ips: "4,429,824 IPs", code: "au", href: "/australia/residential/" },
//         { name: "Canada", ips: "4,429,824 IPs", code: "ca", href: "/canada" },
//         { name: "Mexico", ips: "4,429,824 IPs", code: "mx", href: "/mexico/residential/" },
//         { name: "China", ips: "4,429,824 IPs", code: "cn", href: "/china/residential/" },
//         { name: "France", ips: "4,429,824 IPs", code: "fr", href: "/france/residential/" },
//       ]
//     }
//   },
//   {
...
export default function Navbar() {
  ...
  return (
    <>
      <header
        className={`fixed top-0 left-0 right-0 z-50 overflow-visible transition-all duration-300 font-['Urbanist'] ${
      ...
      >
        <nav className="max-w-[1400px] mx-auto px-6 py-4 h-auto flex items-center justify-between overflow-visible font-['Urbanist']">
                        ...
                        {link.menuType === "reseller-mega" && !Array.isArray(link.dropdown) && (
                          <div className="grid grid-cols-12 gap-6 items-stretch p-2 bg-[#0d0d0f]">
                            ...
                            {(link.dropdown as any).rightCard && (
                              <div className="col-span-5 bg-[#40281e] rounded-[24px] p-8 flex flex-col justify-between min-h-[380px]">
                                <div className="space-y-4">
                                  <h4 className="text-white font-semibold text-[22px] tracking-tight leading-[1.2]">
                                    {(link.dropdown as any).rightCard.title}
                                  </h4>
                                  <p className="text-[14px] text-stone-300 leading-relaxed font-normal opacity-90">
                                    {(link.dropdown as any).rightCard.description}
                                ...
                                <div className="space-y-4 pt-4">
                                  ...
                                  <Link
                                    ...
                                    style={{ perspective: "600px" }}
                                  >
                                    <span className="relative block transition-transform duration-500 ease-in-out group-hover:[transform:rotateX(-90deg)] origin-top">
                                      Learn more
                                    </span>
          ...
          {/* ── Contact Us Button (CSS 3D Flip Transition) ── */}
          <div className="hidden lg:flex items-center overflow-visible">
            <button
              onClick={() => setIsContactOpen(true)}
              className="
