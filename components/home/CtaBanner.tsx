  ...
  return (
    <section className="bg-black py-20 px-6">
      <div className="max-w-7xl mx-auto">
        <div className="relative overflow-hidden bg-[#0a0a0a] border border-gray-800 rounded-[40px] px-8 py-24 text-center">
          ...
          <div className="relative z-10 max-w-3xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
              <button className="bg-[#ff4500] hover:bg-[#e63e00] text-white px-10 py-4 rounded-xl font-bold transition-all shadow-lg shadow-orange-900/20">
                Get Started Now
              </button>
