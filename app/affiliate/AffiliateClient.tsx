...
import TopAnnouncementBar from '../affiliate/TopAnnouncementBar'
...
const FeatureCard = ({ title, description, className = '' }: FeatureCardProps) => (
  <div
    className={`bg-[#121214] border border-stone-800/80 hover:border-stone-700/80 rounded-2xl p-7 transition-all duration-300 ease-out flex flex-col justify-start group hover:bg-[#161619] ${className}`}
  >
    <h3 className="text-white text-xl sm:text-[26px] font-medium tracking-tight mb-3 group-hover:text-orange-400 transition-colors duration-200">
      {title}
    </h3>
    <p className="text-[#858697] text-[18px] sm:text-base leading-relaxed font-regular">
      {description}
    </p>
  </div>
);
...
const socialIcons = [
    ...
    return (
        <div className="bg-[#0a0a0a] text-white font-sans antialiased selection:bg-orange-500 selection:text-white">
            <div className="w-full mb-4 mt-20">
                <TopAnnouncementBar />
            </div>
            {/* ── SECTION 1: HERO CONTAINER ────────────────────────────────── */}
            <header className="relative min-h-[95vh] sm:min-h-0 flex flex-col items-center justify-center px-6 pt-24 sm:pt-32 lg:pt-[89px] pb-24 space-y-6 font-['Urbanist']">
            ...
            <section id="pricing" className="pb-[80px] sm:pb-[80px] mx-[120px] max-w-7xl mx-auto px-6 bg-[#0a0a0a] text-white font-['Urbanist']">
                {/* ── HEADER ─────────────────────────────────────────────── */}
 ...
 <section className="bg-[#0a0a0a] text-white py-12 sm:py-16 md:py-20 px-6 sm:px-12 md:px-16 lg:px-[120px] overflow-hidden font-['Urbanist']">
  <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-8 items-start font-['Urbanist']">

    {/* --- LEFT COLUMN: HEADLINE & CALL TO ACTION --- */}
    <div className="lg:col-span-5 flex flex-col justify-center h-auto lg:h-full lg:sticky top-24">
      <span className="text-[#FF4F00] text-sm sm:text-[16px] font-regular tracking-wider mb-3">
        How it works
      </span>
      <h2 className="text-2xl sm:text-3xl md:text-4xl lg:text-[42px] font-medium tracking-tight leading-[1.15] text-white max-w-md font-['Urbanist']">
        Start earning in 3 simple steps. No experience Needed
      </h2>
      <p className="text-zinc-500 text-base sm:text-[18px] md:text-base mt-4 max-w-md font-regular leading-relaxed font-['Urbanist']">
        From signup to payouts, we made the process effortless so you can focus on what matters, promoting and profiting
      </p>

      {/* Action Button at the bottom */}
      <div className="flex flex-col sm:flex-row items-stretch sm:items-left justify-start gap-4 mb-2 mt-6 sm:mt-8">
        {/* PRIMARY BUTTON */}
        <button 
          onClick={() => router.push('https://affiliate.torchlabs.xyz/register')} 
          className="cursor-pointer group relative w-full sm:w-[260px] h-[56px] overflow-hidden bg-[#FF4F00] text-white font-semibold rounded-xl transition-all duration-200 ease-out shadow-[0_0_20px_rgba(255,79,0,0.25)] hover:shadow-[0_0_35px_rgba(255,79,0,0.6)] hover:scale-[1.02] active:scale-[0.99]"
        >
          {/* Fast 3D text track wrapper */}
          <div className="relative w-full h-full flex flex-col items-center justify-center transition-transform duration-300 ease-out [transform-style:preserve-3d] group-hover:[transform:rotateX(90deg)]">
            <span className="absolute inset-0 flex items-center justify-center [backface-visibility:hidden] [transform:translateZ(12px)]">
    ...
    <div className="lg:col-span-7 relative pl-0 sm:pl-4 lg:pl-12 w-full mt-4 lg:mt-0">

      {/* Vertical Center Connecting Line */}
      <div
        className="absolute left-[27px] sm:left-[43px] lg:left-[75px] top-7 bottom-7 w-[1px] bg-zinc-900"
        aria-hidden="true"
      />

      <div className="space-y-8 sm:space-y-12 relative">
        {steps.map((step) => (
          <div key={step.id} className="flex gap-4 sm:gap-6 lg:gap-8 items-start group">

            {/* Number Orb */}
            <div className="relative z-10 flex items-center justify-center min-w-[56px] h-[56px] rounded-full bg-[#16161a] border border-[#18181B0F] shadow-inner transition duration-300 group-hover:border-zinc-700 font-['Urbanist'] flex-shrink-0">
              <span
                className="text-white text-[22px] sm:text-[24px] font-thin tracking-tight font-['Urbanist']"
                style={{
            ...
            <div className="pt-1 sm:pt-2">
              <h3 className="text-white text-xl sm:text-[24px] font-medium tracking-tight mb-2">
                {step.title}
              </h3>
              <p className="text-zinc-500 text-sm sm:text-[18px] font-regular leading-relaxed max-w-lg">
                {step.description}
              </p>
            </div>
...
<section className="w-full bg-black text-white py-20 px-6 sm:px-10 lg:px-16 font-['Urbanist'] relative overflow-hidden">
      <div className="max-w-7xl mx-auto">
        
        {/* ── HEADER BLOCK ────────────────────────────────────────────── */}
        <div className="flex flex-col md:flex-row md:items-end justify-between gap-6 mb-12">
          <div className="max-w-2xl">
            <span className="text-orange-500 font-regular text-[16px] sm:text-base tracking-wide block mb-3">
              Apply as a creator
            </span>
            <h2 className="text-4xl sm:text-[42px] lg:text-6xl font-medium tracking-tight text-white mb-4">
              Built for content creators
            </h2>
            <p className="text-stone-400 text-base sm:text-[18px] leading-relaxed font-regular">
              Got an audience that trusts your recommendations? Turn your content into recurring revenue with rates designed specifically for creators.
            </p>
          </div>
          ...
          <div className="flex-shrink-0">
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="inline-flex items-center justify-center px-7 py-4 bg-[#FF4F00] hover:bg-[#FF5D14] text-white font-semibold text-base rounded-xl transition-all duration-300 ease-out shadow-[0_0_25px_rgba(255,79,0,0.4)] hover:shadow-[0_0_40px_rgba(255,79,0,0.75)] hover:scale-[1.02] active:scale-[0.98]"
            >
              Become an affiliate now
            </a>
          </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-5">
          ...
          {/* LEFT FEATURE COLUMN (Featured Card + Social Icons) */}
          <div className="lg:col-span-4 flex flex-col justify-between gap-5">
            {/* Main Featured Text Box */}
            <div className="bg-[#121214] border border-stone-800/80 hover:border-stone-700/80 rounded-2xl p-8 flex-1 flex flex-col justify-between relative overflow-hidden group">
              <p className="text-white text-lg sm:text-[25px] leading-relaxed font-medium z-10 mb-8">
                Whether you&apos;re running tutorials, reviews, or deep-dive guides on scraping, automation, or web data tools, your audience is already asking the right questions. Now you can get paid for answering them.
              </p>
              
              {/* Graphic Icon at Bottom Right */}
              <div className="self-end z-10 w-24 h-24 relative transition-transform duration-300 group-hover:scale-110">
                <Image
                  src="/images/chain_link_icon.png"
                  alt="Affiliate Link Icon"
                  width={84}
                  height={84}
                  className="object-contain"
                />
              ...
              <div className="absolute -bottom-10 -right-10 w-36 h-36 bg-orange-500/10 rounded-full blur-2xl group-hover:bg-orange-500/20 transition-all duration-300" />
            </div>

            {/* Social Media Badges Track */}
            <div className="flex items-center gap-3">
              {socialIcons.map((icon) => (
                <div
                  key={icon.name}
                  className="w-24 h-24 bg-[#121214] border border-stone-800/80 hover:border-stone-700/80 rounded-xl flex items-center justify-center transition-all duration-200 hover:scale-105 hover:bg-[#1a1a1d] cursor-pointer"
                >
                  <Image
                    src={icon.src}
                    alt={icon.alt}
          ...
          <div className="lg:col-span-8 grid grid-cols-1 sm:grid-cols-2 gap-5">
            <FeatureCard
              ...
              description="Give your audience an exclusive discount code tied to your account, earning you 10%–20% commission on every purchase made with it."
            />
            <FeatureCard
              title="Dedicated content rewards"
              description="Get a unique tracking link for your channel or page, so every referral from your content is tracked and credited to you automatically."
            />
            <FeatureCard
              title="Performance bonus"
              description="Earn extra on top of your base commission once your referrals hit set monthly milestones."
            />
            <FeatureCard
              title="Priority creative assets"
              description="Early access to banners, demo accounts, and talking points before general affiliates."
            />
          </div>
            ...
            {/* ── SECTION 6: CORE FEATURES ─────────────────────────────────── */}
            <section className="pb-[80px] sm:pb-[80px] mx-[120px] max-w-7xl mx-auto  bg-[#0a0a0a] text-white font-['Urbanist']">
                {/* ── HEADER ─────────────────────────────────────────────── */}
                <div className="text-center mb-20">
...
{/* ── SECTION 6: CORE FEATURES ─────────────────────────────────── */}
<section className="pb-[80px] sm:pb-[80px] px-6 sm:px-12 md:px-16 lg:px-24 max-w-7xl mx-auto bg-[#0a0a0a] text-white font-['Urbanist']">
    {/* ── HEADER ─────────────────────────────────────────────── */}
    <div className="text-center mb-20">
        <span className="text-[#FE4A01] text-[16px] font-regular tracking-wider block mb-3">
            Features
...
<section className="pb-16 sm:pb-20 px-4 sm:px-8 md:px-12 lg:px-24 font-['Urbanist']">
    <div className="max-w-6xl mx-auto">
        <div
            className="relative rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-16 text-center overflow-hidden"
            style={{
        ...
        >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
                <h2 className="text-2xl sm:text-4xl md:text-5xl font-regular tracking-tight mb-4 sm:mb-6 text-white leading-tight sm:leading-none">
                    Earn More With Every Referral<br className="hidden md:block" />
                </h2>

                <p className="text-stone-300 text-sm sm:text-lg md:text-xl mb-6 sm:mb-10 max-w-2xl mx-auto leading-relaxed">
...
<section className="py-12 sm:py-[80px] px-4 sm:px-6 bg-[#0a0a0a] relative overflow-hidden font-['Urbanist']">
