...
const ADVANTAGE_CHECKLIST = [
    "Fresh IPs and steady connections for dependable performance",
    "Built for research, scraping, and account work",
    "24/7 support included as standard",
    "City-level targeting across the country and constantly refreshing IP pool",
] as const;
    ...
    const FEATURES_DATA = [
        {
            ...
            description: "Researching or managing accounts on Australian platforms from overseas gets harder every year, foreign and data center IPs are exactly what Australia's high rate of local data collection has trained sites to distrust. A residential Australian IP resets that: your connection reads as a local visitor in Sydney or Perth, not a flagged offshore range.",
            icon: "/images/Features.svg"
        },
        {
            title: "Data Access & Analysis",
            description: "Woolworths, Coles, JB Hi-Fi, Kogan, Catch, and Google.com.au rankings, all shift between Sydney, Melbourne, and Perth. Australian retail pricing moves by state and freight zone more than most markets, so a single national view misses most of the picture.",
            icon: "/images/Features.svg"
        },
        {
            title: "Unrestricted Access",
            description: "ABC iView, Foxtel, and Australian sports coverage, including the Australian Open, vary by region and license window. A residential Australian connection lets you verify what's actually live in a given market, the way a local viewer would see it.",
            icon: "/images/Features.svg"
        },
                {
            title: "Content Control",
            description: "One Australian connection, one set of rules, restrict content for kids or standardize access across a small team without touching individual devices.",
            icon: "/images/Features.svg"
        },
        {
            title: "Market Research",
            description: "Benchmark competitor pricing across Sydney, Melbourne, Brisbane, and regional markets as EOFY and Black Friday sales roll out, and read Australian consumer trends the way a local shopper sees them, not a flattened overseas view.",
            icon: "/images/Features.svg"
        },
        {
            title: "Social Media Management",
            description: "Shared IPs are what trigger account review flags on Instagram, TikTok, and Facebook. Give each Australian-facing profile its own local-looking connection and manage them side by side without the cross-account link.",
            icon: "/images/Features.svg"
        }
    ];
        ...
        <div className="bg-[#0a0a0a] text-white antialiased selection:bg-orange-500 selection:text-white overflow-x-hidden font-['Urbanist']">
            ...
            <section className="relative z-0 w-full pt-20 md:pt-28 pb-24 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-white font-['Urbanist'] min-h-[600px]">
                ...
                <div className="absolute inset-0 z-0 w-full h-full pointer-events-none">
                    <Image
                        src="/images/hero-cta-bg-australia.png"
                ...
                <div className="relative z-30 max-w-5xl w-full mx-auto flex flex-col items-center text-center space-y-8 mb-8">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-[72px] font-normal leading-[1.15] tracking-tight text-white max-w-7xl w-full">
                        Real Australian Residential Proxies for Market Research
                    </h1>

                    {/* Subtitle Body Text */}
                    <p className="text-gray-300 text-sm sm:text-base md:text-[20px] leading-relaxed max-w-5xl font-normal pt-1">
Real residential IPs from Australian ISPs like Telstra, Optus, and TPG, targetable by city  built for tracking prices on Woolworths and Coles, managing accounts, and researching a markets.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full pt-8">
                        <div className="bg-[#121824]/30 border border-white/10 backdrop-blur-md rounded-2xl p-5 text-center flex flex-col justify-center space-y-1">
                            ...
                            <span className="text-[13px] text-gray-400 font-medium">Aus residential IPs</span>
                        </div>
                        <div className="bg-[#121824]/30 border border-white/10 backdrop-blur-md rounded-2xl p-5 text-center flex flex-col justify-center space-y-1">
            ...
            <section id="pricing" className="bg-[#0a0a0a] text-white py-20 px-6 font-['Urbanist'] mb-[20px]">
                <div className="flex flex-col items-center text-center w-full">
                    ...
                    <h2 className="text-[42px] md:text-[42px] font-medium mb-[20px] max-w-4xl">
                        Buy Australia Residential Proxies
                    </h2>
                </div>
                        ...
                        <div className="lg:col-span-5 bg-[#0B0B0B] border border-[#FFFFFF]/10 rounded-3xl p-8 md:p-10 flex flex-col justify-between space-y-8 backdrop-blur-sm">
                            <div className="space-y-6">
                                ...
                                <p className="text-[#858697] text-base md:text-[18px] leading-relaxed font-regular">
                                    Free proxies rarely survive contact with real Australian sites,  expect timeouts, shared blacklisted IPs, and no support when something breaks. TorchProxies Australia residential proxies run on genuine local household connections built to stay up.
                                </p>
                            </div>
                        </div>
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="relative overflow-hidden bg-[#0a0a0a] rounded-2xl sm:rounded-3xl md:rounded-[40px]">
                        ...
                        <div className="relative rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-16 text-center overflow-hidden bg-[#0a0a0a]">
                            ...
                            <div className="absolute inset-0 z-0 w-full h-full pointer-events-none">
                                <Image
                                    src="/images/australianctaback.png"
                                    alt="CTA Background"
                                    fill
                                    priority
                                    className="object-cover object-center"
                            ...
                            <div className="relative z-20 max-w-full mx-auto">
                                ...
                                <h2 className="text-2xl sm:text-3xl md:text-[48px] font-medium tracking-tight mb-3 sm:mb-4 leading-[1.2] text-white">
                                    Ready to Connect from the United Australia?
