...
const ADVANTAGE_CHECKLIST = [
    "City-level targeting for Taobao, JD.com, and Baidu tracking",
    "Fresh IPs and steady connections for reliable market research",
    "Built for monitoring the Chinese market accurately",
    "24/7 support included whenever a task needs it",
] as const;
    ...
    const FEATURES_DATA = [
        {
            ...
            description: "China's major platforms run some of the toughest anti-bot systems anywhere and treat obvious data center traffic as an automatic block. A genuine residential Chinese IP lets legitimate research and monitoring pass as ordinary local browsing instead of getting flagged on sight, for market research and account management, not for circumventing access controls.",
            icon: "/images/Features.svg"
        },
        {
            title: "Data Access & Analysis",
            description: "Taobao, Tmall, JD.com, 1688, and Baidu rankings all vary by province and shopping festival. Read them from a connection that's genuinely inside China, and the local pricing and promotions show up the way a real shopper sees them.",
            icon: "/images/Features.svg"
        },
        {
            title: "Content Control",
            description: "Standardize what a shared business connection can reach without configuring every device individually, a straightforward way for teams to apply one policy across a network.",
            icon: "/images/Features.svg"
        },
        {
            title: "Unrestricted Access",
            description: "Chinese platforms like iQiyi, Youku, and Bilibili serve different catalogues by region. A residential Chinese IP shows the version a local viewer sees, for licensing checks, localization testing, or content research, not for working around China's own access controls.",
            icon: "/images/Features.svg"
        },

        {
            title: "Market Research",
            description: "Watch consumer behavior and pricing shift around Singles' Day (11.11) and the 618 shopping festival as they happen, benchmark Taobao and JD.com listings against competitors, and collect sentiment data the way it actually appears inside the Chinese market.",
            icon: "/images/Features.svg"
        },
        {
            title: "Social Media Management",
            description: "WeChat, Weibo, and Douyin link accounts that share a connection. Route each profile and each brand-monitoring account — through its own residential Chinese IP to keep them independent.",
            icon: "/images/Features.svg"
        }
    ];
        ...
        <div className="bg-[#0a0a0a] text-white antialiased selection:bg-orange-500 selection:text-white overflow-x-hidden font-['Urbanist']">
            ...
            <section className="relative z-0 w-full pt-20 md:pt-28 pb-24 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-white font-['Urbanist'] min-h-[600px]">
                ...
                <div className="absolute inset-0 z-0 w-full h-full pointer-events-none">
                    <Image
                        src="/images/hero-cta-bg-china.png"
                ...
                <div className="relative z-30 max-w-5xl w-full mx-auto flex flex-col items-center text-center space-y-8 mb-8">
                    ...
                    {/* Main Headline */}
                    <h1 className="text-4xl sm:text-5xl md:text-[72px] font-normal leading-[1.15] tracking-tight text-white max-w-7xl w-full">
                        Real China Residential Proxies for Market Research & Platform Access
                    </h1>

                    {/* Subtitle Body Text */}
                    <p className="text-gray-300 text-sm sm:text-base md:text-[20px] leading-relaxed max-w-5xl font-normal pt-1">
                        Genuine residential IPs from China Telecom, China Unicom, and China Mobile networks, built for reaching Chinese platforms from outside the country for market research, e-commerce monitoring, and more.
                    </p>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 w-full pt-8">
                        <div className="bg-[#121824]/30 border border-white/10 backdrop-blur-md rounded-2xl p-5 text-center flex flex-col justify-center space-y-1">
                            ...
                            <span className="text-[13px] text-gray-400 font-medium">China residential IPs</span>
                        </div>
                        <div className="bg-[#121824]/30 border border-white/10 backdrop-blur-md rounded-2xl p-5 text-center flex flex-col justify-center space-y-1">
                        ...
                        <div className="lg:col-span-5 bg-[#0B0B0B] border border-[#FFFFFF]/10 rounded-3xl p-8 md:p-10 flex flex-col justify-between space-y-8 backdrop-blur-sm">
                            <div className="space-y-6">
                                <h3 className="text-3xl md:text-4xl font-normal leading-tight text-white tracking-tight">
                                    TorchProxies <br />
                                    China Residential<br />
                                    Proxy Advantage<br />

                                </h3>
                                <p className="text-[#858697] text-base md:text-[18px] leading-relaxed font-regular">
                                    Free proxies get blocked almost immediately on China's major platforms, anti-bot systems flag data center traffic on sight. TorchProxies China residential proxies run on genuine local connections built to pass as ordinary local browsing.
                                </p>
                            </div>
                        </div>
                            ...
                            <div className="bg-[#0B0B0B] border border-[#FFFFFF]/10 rounded-3xl p-8 md:p-10 flex flex-col justify-center space-y-5 backdrop-blur-sm">
                                {ADVANTAGE_CHECKLIST.map((item, index) => (
                                    <div key={index} className="flex items-center gap-3.5 group">
                                        ...
                                        <span className="text-[#858697] text-base md:text-[17px] font-normal leading-normal">
                                            {item}
                                        </span>
                                    </div>
                                ))}
                        ...
                        <div className="relative rounded-2xl sm:rounded-3xl p-6 sm:p-10 md:p-16 text-center overflow-hidden bg-[#0a0a0a]">
                            ...
                            <div className="relative z-20 max-w-full mx-auto">
                                ...
                                <h2 className="text-2xl sm:text-3xl md:text-[48px] font-medium tracking-tight mb-3 sm:mb-4 leading-[1.2] text-white">
                                    Ready to Connect from the China?
