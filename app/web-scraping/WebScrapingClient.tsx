        ...
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-4xl mx-auto mb-10 sm:mb-16">
            ...
            <p className="text-stone-400 text-xs sm:text-base lg:text-lg font-normal max-w-3xl mx-auto leading-relaxed">
              Most scraping failures aren’t caused by code, they’re caused by IP
              reputation, detection patterns and unstable sessions.
            </p>
          </div>
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] text-white font-['Urbanist'] overflow-hidden">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-stone-400 text-xs sm:text-base lg:text-lg font-normal leading-relaxed">
            A single proxy solution designed for teams that scrape at scale and
            can’t afford blocks, retries, or wasted spend.
          </p>
        </div>
      </section>
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            ...
            <div className="space-y-6">
              ...
              <p className="text-stone-400 text-xs sm:text-sm lg:text-base font-normal leading-relaxed">
                Built for modern scraping environments where detection
                resistance, consistency and cost control matter more than raw
                bandwidth.
              </p>
              ...
              <ul className="space-y-3 pt-2">
                {[
                  ...
                  <li
                    key={index}
                    className="flex items-center gap-3 text-stone-300 text-xs sm:text-sm lg:text-base"
                  >
      ...
      <section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] text-white font-['Urbanist'] overflow-hidden">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="text-center max-w-3xl mx-auto mb-10 sm:mb-16">
            ...
            <p className="text-stone-400 text-xs sm:text-sm lg:text-base font-normal leading-relaxed">
              Hybrid proxies combine real residential identity with
              high-performance infrastructure so your scraping runs longer,
              costs less and fails less often.
            </p>
          </div>
            ...
            <div className="bg-[#0A0A0A] border border-stone-900 rounded-2xl p-6 sm:p-8 flex flex-col justify-between transition-all duration-200 hover:border-stone-800 w-full min-h-[580px]">
              <div>
                ...
                <p className="text-stone-400 text-sm sm:text-base font-normal mb-6 leading-relaxed max-w-sm">
                  Built for high volume scraping on both protected and
                  unprotected targets
                </p>
            ...
            <div className="min-w-[700px] lg:min-w-full relative">
              <table className="w-full border-collapse text-center table-fixed relative z-10">
                <colgroup>
                  ...
                  <col className="w-[16%]" />
                  <col className="w-[16%]" />{" "}
                  {/* Highlighted TorchProxies Column */}
                  <col className="w-[16%]" />
                  <col className="w-[16%]" />
                </colgroup>
          ...
          >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-stone-300 text-xs sm:text-base lg:text-lg mb-8 sm:mb-10 max-w-2xl mx-auto font-normal leading-relaxed">
                Avoid blocks, retries and wasted data by using hybrid proxies
                built for steady, large-scale web scraping on both protected and
                open websites.
              </p>
