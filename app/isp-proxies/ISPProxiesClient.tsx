  ...
  <div className="max-w-7xl mx-auto">
    ...
    <div className="text-center mb-10 sm:mb-16">
      ...
      <div className="flex flex-wrap items-center justify-center gap-x-6 gap-y-3 text-stone-400 text-xs sm:text-sm font-medium max-w-4xl mx-auto">
        ...
        <span className="flex items-center gap-1.5"><Check className="text-emerald-400 w-4 h-4 stroke-[3] shrink-0" /> Reliable & stable connection</span>
          ...
          >
            ...
            <div className="flex items-center gap-3 pt-3 sm:pt-4 border-t border-stone-900/50">
              {review.avatar ? (
                ...
                <div className={`w-9 h-9 sm:w-11 sm:h-11 flex items-center justify-center rounded-full text-stone-950 font-bold text-xs sm:text-sm tracking-wider uppercase shrink-0 ${review.initials === "IS" ? "bg-[#c6f6d5]" : "bg-[#7f9cf5] text-white"}`}>
                  {review.initials}
                </div>
              )}
              <div className="flex flex-col min-w-0">
