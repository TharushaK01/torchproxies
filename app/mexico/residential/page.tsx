...
const ADVANTAGE_CHECKLIST = [
    "City-level targeting down to Mexico City, Guadalajara, and Monterrey",
    "Built for research, scraping, and account management",
    "Fresh IPs and consistent uptime",
    ...
    const FEATURES_DATA = [
        {
            ...
            description: "Mexican marketplaces fingerprint and rate-limit hard around checkout, exactly where non-residential traffic is most likely to get flagged mid-session. A genuine Mexican household IP, handled under the LFPDPPP data protection standard, holds that session the way a real shopper's connection would, from browse through payment.",
            icon: "/images/Features.svg"
        },
        {
            title: "Data Access & Analysis",
            description: "Track pricing and availability on Mercado Libre, Walmart México, Liverpool, and Coppel exactly as a Mexican shopper sees them. Prices and delivery estimates shift by city and postal code, Mexico City, Guadalajara, and Monterrey routinely show different numbers for the same product.",
            icon: "/images/Features.svg"
        },
        {
            title: "Content Control",
            description: "Set access rules once, at the connection level, on a Mexican household or office line, restrict content for younger users or standardize what a shared network reaches, without touching every device.",
            icon: "/images/Features.svg"
        },
        {
            title: "Unrestricted Access",
            description: "Mexican streaming platforms and Liga MX broadcasts often restrict by region. A residential Mexican IP shows the local catalogue and match coverage the way a viewer inside the country would see it, useful for licensing checks and market verification.",
            icon: "/images/Features.svg"
        },

        {
            title: "Market Research",
            description: "Follow competitor pricing through El Buen Fin, Hot Sale, and the Día de las Madres shopping season, and read Mercado Libre and Amazon.com.mx listings the way Mexican consumers actually encounter them, mobile-first and in pesos.",
            icon: "/images/Features.svg"
        },
        {
            title: "Social Media Management",
            description: "A shared IP is enough to link every Instagram, Facebook, or WhatsApp Business profile together. Give each Mexican-facing account its own residential connection, and agencies can run several client accounts side by side without the tell.",
            icon: "/images/Features.svg"
        }
    ];
            ...
            <section className="relative z-0 w-full pt-20 md:pt-28 pb-24 md:pb-20 px-6 overflow-hidden flex flex-col items-center justify-center text-white font-['Urbanist'] min-h-[600px]">
                ...
                <div className="relative z-30 max-w-5xl w-full mx-auto flex flex-col items-center text-center space-y-8 mb-8">
                    ...
                    <h1 className="text-4xl sm:text-5xl md:text-[72px] font-normal leading-[1.15] tracking-tight text-white max-w-7xl w-full">
                        Fast, Reliable Mexico Residential Proxies for E-Commerce & Checkout Testing
                    </h1>

                    {/* Subtitle Body Text */}
                    <p className="text-gray-300 text-sm sm:text-base md:text-[20px] leading-relaxed max-w-5xl font-normal pt-1">
                        Real residential IPs across Mexico, city-targetable built for reading Mercado Libre and Walmart México the way a local shopper does, and for holding a session through a full checkout flow.
                    </p>
            ...
            <section id="pricing" className="bg-[#0a0a0a] text-white py-20 px-6 font-['Urbanist'] mb-[20px]">
                <div className="flex flex-col items-center text-center w-full">
                    ...
                    <h2 className="text-[42px] md:text-[42px] font-medium mb-[20px] max-w-4xl">
                        Buy Mexico Residential Proxies
                    </h2>
                </div>
                        ...
                        <div className="lg:col-span-5 bg-[#0B0B0B] border border-[#FFFFFF]/10 rounded-3xl p-8 md:p-10 flex flex-col justify-between space-y-8 backdrop-blur-sm">
                            <div className="space-y-6">
                                ...
                                <p className="text-[#858697] text-base md:text-[18px] leading-relaxed font-regular">
                                    Mexican marketplaces move fast and flag fast, a free proxy that gets rate-limited or blacklisted mid-session costs you the data or the account. TorchProxies Mexico residential proxies run on genuine household connections built to hold up under that pace.
                                </p>
                            </div>
                        </div>
