...
export default function TorchProxiesLandingPage() {
  ...
  const locationsData: LocationDataSet = {
    ...
    isp: [
      { country: "United States", ips: "1,250,400 IPs", code: "US",  url: '/united-states-isp' },
      { country: "United Kingdom", ips: "185,200 IPs", code: "GB", url: '/united-kingdom-isp' },
      { country: "Germany", ips: "430,150 IPs", code: "DE",  url: '/germany-isp' },
      { country: "Australia", ips: "92,400 IPs", code: "AU", url: '/australia-isp'  },
      { country: "Canada", ips: "210,900 IPs", code: "CA", url: '/canada-isp' },
      { country: "Mexico", ips: "312,000 IPs", code: "MX", url: '/mexico-isp' },
      { country: "China", ips: "890,500 IPs", code: "CN", url: '/china-isp' },
      { country: "France", ips: "520,300 IPs", code: "FR", url: '/france-isp'  },
    ],
  };
 ...
 const locations: LocationsData = {
    ...
    isp: [
      { name: "South Korea", ips: "4,421,924 IPs", code: "KR" , url: '/south-korea-isp' },
      { name: "Ireland", ips: "4,421,924 IPs", code: "IE" , url: '/ireland-isp' },
      { name: "Iran", ips: "4,421,924 IPs", code: "IR" , url: '/iran-isp' },
      { name: "Chile", ips: "4,421,924 IPs", code: "CL" , url: '/chile-isp' },
      { name: "Argentina", ips: "4,421,924 IPs", code: "AR", url: '/argentina-isp'  },
      { name: "Brazil", ips: "1,421,960 IPs", code: "BR", url: '/brazil-isp'  },
      { name: "Belgium", ips: "155,240 IPs", code: "BE", url: '/belgium-isp'  },
      { name: "Czechia", ips: "210,500 IPs", code: "CZ", url: '/czechia-isp'  },
      { name: "Israel", ips: "4,421,924 IPs", code: "IL" , url: '/israel-isp' },
      { name: "Italy", ips: "4,421,924 IPs", code: "IT" , url: '/italy-isp' },
      { name: "Kenya", ips: "4,421,924 IPs", code: "KE", url: '/kenya-isp'  },
      { name: "Malaysia", ips: "4,421,924 IPs", code: "MY", url: '/malaysia-isp'  },
      { name: "Nigeria", ips: "4,421,924 IPs", code: "NG", url: '/nigeria-isp'  },
      { name: "Norway", ips: "4,421,924 IPs", code: "NO", url: '/norway-isp'  },
      { name: "Pakistan", ips: "4,421,924 IPs", code: "PK", url: '/pakistan-isp'  },
      { name: "Peru", ips: "4,421,924 IPs", code: "PE", url: '/peru-isp'  },
      { name: "Philippines", ips: "4,421,924 IPs", code: "PH", url: '/philippines-isp'  },
      { name: "Poland", ips: "4,421,924 IPs", code: "PL", url: '/poland-isp'  },
      { name: "Portugal", ips: "4,421,924 IPs", code: "PT" , url: '/portugal-isp' },
      { name: "Russia", ips: "4,421,924 IPs", code: "RU", url: '/russia-isp'  },
      { name: "Spain", ips: "4,421,924 IPs", code: "ES", url: '/spain-isp'  },
      { name: "Switzerland", ips: "4,421,924 IPs", code: "CH", url: '/switzerland-isp'  },
      { name: "Taiwan", ips: "4,421,924 IPs", code: " TW" , url: '/taiwan-isp' },
      { name: "Thailand", ips: "4,421,924 IPs", code: "TH", url: '/thailand-isp'  },
      { name: "Turkey", ips: "4,421,924 IPs", code: "TR", url: '/turkey-isp'  },
      { name: "Ukraine", ips: "4,421,924 IPs", code: "UA", url: '/ukraine-isp'  },
      { name: "Vietnam", ips: "4,421,924 IPs", code: "VN" , url: '/vietnam-isp' },
      { name: "Venezuela", ips: "4,421,924 IPs", code: "VE", url: '/venezuela-isp'  },
      { name: "Netherlands", ips: "4,421,924 IPs", code: "NL" , url: '/netherlands-isp' },
      { name: "Finland", ips: "4,421,924 IPs", code: "FI", url: '/finland-isp'  },
      { name: "Denmark", ips: "4,421,924 IPs", code: "DK", url: '/denmark-isp'  },
      { name: "Indonesia", ips: "4,421,924 IPs", code: "ID", url: '/indonesia-isp'  }
    ]
};
