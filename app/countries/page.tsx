...
export default function TorchProxiesLandingPage() {
  ...
  const locationsData: LocationDataSet = {
    residential: [
      { country: "United States", ips: "4,429,824 IPs", code: "US", url: '/united-states' },
      { country: "United Kingdom", ips: "1,449,139 IPs", code: "GB", url: '/united-kingdom' },
      { country: "Germany", ips: "1,431,960 IPs", code: "DE",  url: '/germany' },
      { country: "Australia", ips: "452,720 IPs", code: "AU", url: '/australia' },
      { country: "Canada", ips: "815,658 IPs", code: "CA", url: '/canada' },
      { country: "Mexico", ips: "4,429,824 IPs", code: "MX", url: '/mexico' },
      { country: "China", ips: "4,429,824 IPs", code: "CN", url: '/china' },
      { country: "France", ips: "4,429,824 IPs", code: "FR", url: '/france'  },
    ],
    isp: [
      { country: "United States", ips: "4,429,824 IPs", code: "US",  url: '/united-states-isp' },
      { country: "United Kingdom", ips: "1,449,139 IPs", code: "GB", url: '/united-kingdom-isp' },
      { country: "Germany", ips: "1,431,960 IPs", code: "DE",  url: '/germany-isp' },
      { country: "Australia", ips: "452,720 IPs", code: "AU", url: '/australia-isp'  },
      { country: "Canada", ips: "815,658 IPs", code: "CA", url: '/canada-isp' },
      { country: "Mexico", ips: "4,429,824 IPs", code: "MX", url: '/mexico-isp' },
      { country: "China", ips: "4,429,824 IPs", code: "CN", url: '/china-isp' },
      { country: "France", ips: "4,429,824 IPs", code: "FR", url: '/france-isp'  },
    ],
  };
 ...
 const locations: LocationsData = {
    residential: [
      ...
      { name: "Argentina", ips: "5,323,715 IPs", code: "AR", url: '/argentina'  },
      { name: "Brazil", ips: "7,284,744 IPs", code: "BR" , url: '/brazil' },
      { name: "Belgium", ips: "155,057 IPs", code: "BE", url: '/belgium'  },
      ...
      { name: "Pakistan", ips: "4,421,824 IPs", code: "PK", url: '/pakistan'  },
      { name: "Peru", ips: "4,421,824 IPs", code: "PE", url: '/peru'  },
      { name: "Philippines", ips: "4,421,824 IPs", code: "PH", url: '/philippines'  },
      ...
      { name: "Switzerland", ips: "4,421,824 IPs", code: "CH", url: '/switzerland'  },
      { name: "Taiwan", ips: "4,421,824 IPs", code: "TW", url: '/taiwan'  },
      { name: "Thailand", ips: "4,421,824 IPs", code: "TH", url: '/thailand'  },
      { name: "Turkey", ips: "4,421,824 IPs", code: "TR" , url: '/turkey' },
      { name: "Ukraine", ips: "4,421,824 IPs", code: "UA", url: '/ukraine'  },
      { name: "Vietnam", ips: "4,421,824 IPs", code: "VN", url: '/vietnam'  },
      { name: "Venezuela", ips: "4,421,824 IPs", code: "VE", url: '/venezuela'  },
      { name: "Netherlands", ips: "4,421,824 IPs", code: "NL", url: '/netherlands'  },
      { name: "Finland", ips: "4,421,824 IPs", code: "FI", url: '/finland'  },
      { name: "Denmark", ips: "4,421,824 IPs", code: "DK", url: '/denmark'  },
    ...
    isp: [
      ...
      { name: "Argentina", ips: "5,323,715 IPs", code: "AR", url: '/argentina-isp'  },
      { name: "Brazil", ips: "7,284,744 IPs", code: "BR", url: '/brazil-isp'  },
      { name: "Belgium", ips: "155,057 IPs", code: "BE", url: '/belgium-isp'  },
      { name: "Czechia", ips: "130,363 IPs", code: "CZ", url: '/czechia-isp'  },
      { name: "Israel", ips: "4,421,824 IPs", code: "IL" , url: '/israel-isp' },
      { name: "Italy", ips: "4,421,824 IPs", code: "IT" , url: '/italy-isp' },
      { name: "Kenya", ips: "4,421,824 IPs", code: "KE", url: '/kenya-isp'  },
      { name: "Malaysia", ips: "4,421,824 IPs", code: "MY", url: '/malaysia-isp'  },
      { name: "Nigeria", ips: "4,421,824 IPs", code: "NG", url: '/nigeria-isp'  },
      { name: "Norway", ips: "4,421,824 IPs", code: "NO", url: '/norway-isp'  },
      { name: "Pakistan", ips: "4,421,824 IPs", code: "PK", url: '/pakistan-isp'  },
      { name: "Peru", ips: "4,421,824 IPs", code: "PE", url: '/peru-isp'  },
      { name: "Philippines", ips: "4,421,824 IPs", code: "PH", url: '/philippines-isp'  },
      { name: "Poland", ips: "4,421,824 IPs", code: "PL", url: '/poland-isp'  },
      { name: "Portugal", ips: "4,421,824 IPs", code: "PT" , url: '/portugal-isp' },
      { name: "Russia", ips: "4,421,824 IPs", code: "RU", url: '/russia-isp'  },
      { name: "Spain", ips: "4,421,824 IPs", code: "ES", url: '/spain-isp'  },
      { name: "Switzerland", ips: "4,421,824 IPs", code: "CH", url: '/switzerland-isp'  },
      { name: "Taiwan", ips: "4,421,824 IPs", code: " TW" , url: '/taiwan-isp' },
      { name: "Thailand", ips: "4,421,824 IPs", code: "TH", url: '/thailand-isp'  },
      { name: "Turkey", ips: "4,421,824 IPs", code: "TR", url: '/turkey-isp'  },
      { name: "Ukraine", ips: "4,421,824 IPs", code: "UA", url: '/ukraine-isp'  },
      { name: "Vietnam", ips: "4,421,924 IPs", code: "VN" , url: '/vietnam-isp' },
      { name: "Venezuela", ips: "4,421,824 IPs", code: "VE", url: '/venezuela-isp'  },
      { name: "Netherlands", ips: "4,421,824 IPs", code: "NL" , url: '/netherlands-isp' },
      { name: "Finland", ips: "4,421,824 IPs", code: "FI", url: '/finland-isp'  },
      { name: "Denmark", ips: "4,421,824 IPs", code: "DK", url: '/denmark-isp'  },
      { name: "Indonesia", ips: "4,421,824 IPs", code: "ID", url: '/indonesia-isp'  }
    ]
};
  ...
  <div className="max-w-6xl mx-auto relative z-10 flex flex-col items-center">
    ...
    <div className="inline-flex bg-[#0f0f11] border border-stone-900/90 rounded-full p-1.5 mb-14 select-none">
      <button
        ...
        className={`px-5 py-2 rounded-full text-[14px] font-regular tracking-wider transition-all duration-200 ${
