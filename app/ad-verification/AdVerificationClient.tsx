        ...
        <ul className="space-y-3 text-stone-300 text-xs sm:text-sm leading-relaxed">
          {[
            ...
            <li key={idx} className="flex items-start gap-2.5">
              <span className="text-[#FF4F00] text-base leading-none select-none">•</span>
              <span>{item}</span>
            </li>
          ))}
        </ul>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-3 pt-2">
              {card.features.map((feature, idx) => (
                <li key={idx} className="flex items-start gap-3 text-stone-300 text-xs sm:text-sm leading-relaxed">
                  <svg
...
<section className="py-12 sm:py-16 lg:py-20 px-4 sm:px-6 lg:px-8 bg-[#0a0a0a] text-white font-['Urbanist'] overflow-hidden">
  <div className="max-w-6xl mx-auto">
    <div
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(255, 60, 0, 0.2) 0%, #0a0a0a 30%, #0a0a0a 80%, rgba(255, 60, 0, 0.2) 100%)',
      }}
    >
