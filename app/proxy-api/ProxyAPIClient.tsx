...
const steps: Step[] = [
  {
    ...
    description:
      "Sign up on TorchProxies to unlock reseller tools and API access.",
  },
  {
    id: "02",
    title: "Add Funds & Get API Key",
    description:
      "Deposit as low as $1 and copy your API key to start integrating.",
  },
  {
    id: "03",
    title: "Start Selling Proxies",
    description:
      "Connect the API to your system and begin offering proxies to your clients instantly.",
  },
];
      ...
      <header className="relative z-20 min-h-[95vh] sm:min-h-0 flex flex-col items-center justify-center mt-[80px] px-6 pt-28 pb-12 overflow-visible space-y-6 font-['Urbanist']">
        ...
        <div className="max-w-6xl mx-auto text-center z-10 font-['Urbanist']">
          ...
          <p className="max-w-4xl mx-auto text-stone-400 text-[16px] sm:text-xl mb-6 leading-relaxed">
            Use our Proxy API to create sub users, assign data, generate proxies
            and build your own reseller dashboard or proxy storefront with full
            control over pricing and UI.
          </p>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4 pb-15 mt-8">
            ...
            <button
              onClick={() =>
                router.push(
                  "https://api.playground.torchproxies.com/introduction/",
                )
              }
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 order-2 lg:order-2">
              ...
              <p className="text-stone-400 text-sm sm:text-base lg:text-lg leading-relaxed">
                The TorchProxies Proxy API is a developer-friendly backend that
                lets you programmatically manage proxy access for your users.
                Instead of clicking through a dashboard, you can automate
                critical operations seamlessly:
              </p>
              ...
              <ul className="space-y-2.5 text-stone-300 text-xs sm:text-sm lg:text-base">
                {[
                  ...
                  <li key={idx} className="flex items-center gap-3">
                    <span className="text-[#FE4A01] font-bold select-none">
                      —
                    </span>
                    <span>{item}</span>
                  </li>
              ...
              <p className="text-stone-400 text-sm sm:text-base lg:text-lg leading-relaxed pt-2">
                This API becomes the engine behind your proxy site, SaaS
                platform, automation tool, or internal system while TorchProxies
                handles the IP networks, sourcing, uptime, and quality.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-12 items-start">
          ...
          <div className="lg:col-span-5 flex flex-col justify-center lg:sticky lg:top-24">
            ...
            <p className="text-stone-400 text-sm sm:text-base lg:text-lg mt-3 sm:mt-4 max-w-md font-normal leading-relaxed">
              Follow simple steps to launch your proxy business with
              TorchProxies—no infrastructure or IP blocks needed.
            </p>
                ...
                >
                  ...
                  <div className="relative z-10 flex items-center justify-center min-w-[48px] h-[48px] sm:min-w-[56px] sm:h-[56px] rounded-full bg-[#16161a] border border-stone-800/80 shadow-inner transition duration-300 group-hover:border-stone-700 shrink-0">
                    <span
                      ...
                      style={{
                        textShadow:
                          "-1.5px 0px 0px rgba(0, 229, 255, 0.8), 1.5px 0px 0px rgba(255, 152, 0, 0.8)",
                      }}
                    >
                      {parseInt(step.id, 10)}
                    </span>
        ...
        <div className="max-w-7xl mx-auto space-y-16 sm:space-y-24 lg:space-y-32">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 sm:gap-12 lg:gap-16 items-center">
            ...
            <div className="space-y-4 sm:space-y-6 order-2 lg:order-1">
              ...
              <p className="text-stone-400 text-sm sm:text-base lg:text-lg leading-relaxed">
                Access clear, developer-ready API guides to help you integrate
                TorchProxies’ Proxy API in minutes. Learn how to manage
                sub-users, set traffic limits, and generate proxy formats with
                simple REST calls:
              </p>
          ...
          >
            ...
            <div className="relative z-10 max-w-4xl mx-auto">
              ...
              <p className="text-stone-300 text-sm sm:text-lg md:text-xl mb-8 sm:mb-10 max-w-2xl mx-auto font-normal leading-relaxed">
                Build your own dashboard, choose your margins, and offer
                multiple proxy types under your own brand using our open,
                flexible API.
              </p>
