...
export default function TorchProxiesLandingPage() {
  ...
  return (
    <div className="bg-[#0a0a0a] text-white font-sans antialiased selection:bg-orange-500 selection:text-white overflow-x-hidden space-y-6 font-['Urbanist']">
        ...
        <div className="max-w-6xl mx-auto text-center z-10 font-['Urbanist']">
          ...
          <h1 className="text-[60px] sm:text-[60px] lg:text-[60px] font-regular tracking-tight leading-[72px] mb-6 bg-gradient-to-b from-white via-stone-200 to-stone-500 bg-clip-text text-transparent">
            ...
            <span className="bg-gradient-to-b from-white via-stone-200 to-stone-200 bg-clip-text text-transparent">
              Access 30M+ Global IPs
            </span>
          </h1>

          <p className="max-w-3xl mx-auto text-stone-400 text-base text-[18px] sm:text-[18px] mb-4 leading-relaxed">
            Reliable and steady residential proxies, perfect for everyday tasks.
            A balanced choice that gets the job done without breaking the bank.
          </p>
          ...
          <div className="py-8 max-w-2xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-2 text-stone-200 text-[16px] font-medium">
            <div className="flex items-center justify-center gap-2">
              <Check className="text-orange-500 w-4 h-4" /> Rotating & Static
              IPs
            </div>
            <div className="flex items-center justify-center gap-2">
              <Check className="text-orange-500 w-4 h-4" /> Unlimited
              Concurrency
            </div>
            <div className="flex items-center justify-center gap-2">
              <Check className="text-orange-500 w-4 h-4" /> 195+ Countries
              Network
            </div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
            ...
            <div className="space-y-6 font-['Urbanist']">
              ...
              <p className="text-gray-400 text-[18px] leading-relaxed">
                Torch Proxies' Standard Residential proxies are a simple,
                reliable choice for routine web tasks. With a large global IP
                pool and stable performance, this plan suits users who need
                consistent access for day-to-day scraping, monitoring, and basic
                automation — without the cost or complexity of higher-tier
                plans.
              </p>
      ...
      <section
        id="pricing"
        className="py-12 sm:py-20 lg:py-24 bg-[#0a0a0a] text-white relative overflow-hidden space-y-6 font-['Urbanist']"
      >
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-start mt-4">
            ...
            <div className="lg:col-span-6 space-y-2 lg:pr-4">
              ...
              <p className="text-stone-400 text-sm sm:text-base leading-relaxed mb-6 mt-4">
                ...
                optional static sessions{" "}
                <span className="text-[#FE4A01]">
                  perfect for everyday online tasks.
                </span>
              </p>
            ...
            >
              <div className="max-w-5xl relative z-10 mx-auto">
                ...
                <p className="max-w-3xl mx-auto text-gray-400 text-sm sm:text-lg md:text-xl font-normal leading-relaxed mb-6 sm:mb-8 text-center">
                  Get dependable, easy to use residential proxies built for
                  everyday automation, testing, and data collection.
                </p>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 lg:gap-12 items-center">
              ...
              <div className="lg:col-span-7 space-y-6">
                ...
                <ul className="space-y-3 text-stone-400 text-sm sm:text-base md:text-[16px] font-normal">
                  ...
                  <li className="flex items-center gap-2.5">
                    <Check className="text-emerald-500 w-4 h-4 shrink-0" /> 90M+
        ...
        <div className="max-w-6xl mx-auto px-6">
          ...
          <div className="text-center mb-16">
            <h2 className="text-[42px] sm:text-5xl font-medium mb-4 tracking-tight text-white">
              Customers prefer Torch Proxies over other
              <br /> proxy brands
            </h2>
          </div>
                ...
                >
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-stone-900/50">
                    {review.avatar ? (
                      ...
                      <div
                        className={`w-11 h-11 flex items-center justify-center rounded-full text-stone-950 font-bold text-sm tracking-wider ${review.initials === "IS" ? "bg-[#c6f6d5]" : "bg-[#7f9cf5] text-white"}`}
                      >
                        {review.initials}
                      </div>
                    )}
